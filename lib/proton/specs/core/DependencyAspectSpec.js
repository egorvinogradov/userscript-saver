describe('DependencyAspect', function() {
	var dependencyAdvice
	beforeEach(function() {
		dependencyAdvice = new DependencyAspect()
	})

	it('listens to changes in all given methods and adds method ._adviceAddDependent', function() {
